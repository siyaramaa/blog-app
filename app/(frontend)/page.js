...
const Banner = dynamic(() => import("@/components/Banner"), {
  ...
  loading: () => (
    <div
      role="status"
      className="animate-pulse container h-[40vh] sm:h-[50vh]  mx-auto md:h-[60vh] lg:h-[50vh] max-w-screen-sm p-6  dark:from-inherit dark:to-inherit relative dark:bg-gray-800"
    >
      <svg
